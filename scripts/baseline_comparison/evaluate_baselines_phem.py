...
def run_evaluate_baselines(
    ...
    experiments = [
        Experiment(
            expname=expname, name=f"zeroshot_single_best",
            run_fun=lambda: zeroshot_results(**experiment_common_kwargs, ensemble_method_name="single_best")
        ),
        Experiment(
            expname=expname, name=f"zeroshot_ges",
            run_fun=lambda: zeroshot_results(**experiment_common_kwargs, ensemble_method_name="greedy_ensemble_selection")
        ),
        Experiment(
            expname=expname, name=f"zeroshot_phem_ges",
            run_fun=lambda: zeroshot_results(**experiment_common_kwargs, ensemble_method_name="phem_greedy_ensemble_selection")
        ),
        Experiment(
            expname=expname, name=f"zeroshot_cmaes",
            run_fun=lambda: zeroshot_results(**experiment_common_kwargs, ensemble_method_name="cmaes")
        ),
        Experiment(
            expname=expname, name=f"zeroshot_cmaes_with_normalization",
            run_fun=lambda: zeroshot_results(**experiment_common_kwargs, ensemble_method_name="cmaes_with_normalization")
        ),
        Experiment(
            expname=expname, name=f"zeroshot_quality_optimization",
            run_fun=lambda: zeroshot_results(**experiment_common_kwargs, ensemble_method_name="quality_optimization")
        ),
        Experiment(
            expname=expname, name=f"zeroshot_quality_diversity_optimization",
            run_fun=lambda: zeroshot_results(**experiment_common_kwargs, ensemble_method_name="quality_diversity_optimization")
        ),
    ]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--engine", type=str, required=False, default="sequential", choices=["sequential", "ray", "joblib"],
    ...
    run_evaluate_baselines(
        ...
        engine="ray",
        ray_process_ratio=0.5,
        run_expensive_simulations=False,
    )